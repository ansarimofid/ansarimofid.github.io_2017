        ...
        <section className="uk-margin-large-top">
          <div className="mail-phone uk-flex uk-flex-wrap">
            <div className="mail uk-margin-medium-right">
              ...
              <a className="color-grey-54" href="mailto:ansarimofid@gmail.com?Subject=Hello" target="_top">
                ansarimofid@gmail.com</a>
            </div>
            <div className="phone uk-margin-medium-right">
              <span className="uk-text-uppercase color-primary text-medium">Phone:</span><span
              className="color-grey-54"> +91 9554597890</span>
            </div>
          </div>
        </section>
          ...
          <div className="form-container">
            <form method="POST" action="http://formspree.io/ansarimofid@gmail.com">
              <fieldset className="uk-fieldset">
                ...
                <div className="uk-margin">
                  <textarea className="uk-textarea text-size-14" name="query" rows="5"
